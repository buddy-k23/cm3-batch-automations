...
from src.services.onboarding_vcs_service import (
    default_branch_name as _default_branch_name,
)
from src.services.onboarding_vcs_service import open_mr_pipeline as _open_mr_pipeline
