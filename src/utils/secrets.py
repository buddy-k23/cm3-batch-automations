...
For HashiCorp Vault (``vault``):
    ...
    ``VAULT_SECRET_PATH`` (default: ``secret/data/valdo``).
...
class HashiCorpVaultSecretsProvider(SecretsProvider):
    ...
    Args:
        ...
        secret_path: KV v2 secret path (default: ``secret/data/valdo``).
    """
    ...
    def __init__(
        ...
        role_id: str,
        secret_id: str,
        secret_path: str = "secret/data/valdo",
    ) -> None:
...
def get_secrets_provider() -> SecretsProvider:
    ...
    if provider_name == "vault":
        ...
        return HashiCorpVaultSecretsProvider(
            ...
            secret_path=os.getenv("VAULT_SECRET_PATH", "secret/data/valdo"),
        )
