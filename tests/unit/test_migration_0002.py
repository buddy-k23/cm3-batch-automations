...
def test_upgrade_targets_app_run_history():
    """upgrade() must apply idempotency guards to APP_RUN_HISTORY."""
    source = _read_source()
    assert "APP_RUN_HISTORY" in source, (
        "APP_RUN_HISTORY table not referenced in migration 0002"
    )
