...
REM Usage:
REM   run_qa_app_int_e2e.windows.bat [ROOT] [PYTHON_EXE]
REM Example:
REM   run_qa_app_int_e2e.windows.bat C:\workspace\database-validations C:\workspace\valdo\.venv\Scripts\python.exe

set "ROOT=%~1"
if "%ROOT%"=="" set "ROOT=C:\workspace\database-validations"

set "PYTHON_EXE=%~2"
if "%PYTHON_EXE%"=="" set "PYTHON_EXE=C:\workspace\valdo\.venv\Scripts\python.exe"
...
set "ORACLE_SCRIPT=%ROOT%\tools\e2e_app_int_oracle.py"
set "ARTIFACT_SCRIPT=%ROOT%\tools\e2e_app_int_to_wave_artifacts.py"
...
echo - %ROOT%\generated\e2e_app_int\wave_artifacts\telemetry.json
